...
Halfway through the hackathon, we host a dedicated MVP Demo Day where teams showcase their product (should we live on testnet with smart contracts, backend, and basic frontend), where the 2–3 strongest teams win Mac Mini hardware awards, before final judging even begins.
...
Tooling and infrastructure grants
